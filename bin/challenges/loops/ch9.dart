...
void main() {
  ...
  if (input == 'no') {
    ...
    print('*Coach grumbles "God I hate mondays".\nCoach screams: COUNTDOWN BEGINS NOW! START RUNNING!');

    // int lap = START , lap <=10 = WHILE , lap-- = Add/remove every count.
    for(int lap = 10; lap >= lapsLeft; lap--) {
      print('$lap');
    }
  }
}
